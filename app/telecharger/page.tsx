...
export default function DownloadPage() {
  ...
  return (
    <main id="main-content" tabIndex={-1} className="relative grid min-h-screen place-items-center overflow-hidden bg-[#0f1f3d] px-5 text-white">
      <div className="pointer-events-none absolute -right-20 -top-24 -z-10 h-96 w-96 rounded-full bg-[#f59e0b]/20 blur-3xl" />
      ...
      <section className="animate-scale-in max-w-lg rounded-[2rem] border border-white/10 bg-[#153f39] p-8 text-center shadow-2xl sm:p-10">
        <span className="mx-auto grid h-14 w-14 place-items-center rounded-2xl bg-[#f59e0b] text-[#0f1f3d]">
          <Download size={26} />
        </span>
        ...
        <Link
          href="/"
          className="mt-7 inline-flex rounded-full bg-[#f59e0b] px-5 py-3 font-bold text-[#0f1f3d] shadow-gold transition hover:bg-[#f5cd93]"
        >
