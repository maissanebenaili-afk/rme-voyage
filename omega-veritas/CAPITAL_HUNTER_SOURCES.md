...
| BOAMP | API gratuite | marchés publics, avis et résultats | 0€ | https://boamp-datadila.opendatasoft.com/api/explore/v2.1/catalog/datasets/boamp/records | REAL_FIXTURE (`BOAMP_ODS`, 12 avis capturés 2026-09-23) + SYNTHETIC_TEST (`BOAMP`) |
